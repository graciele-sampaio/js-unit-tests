...
//Teste se o parâmetro não for número, a função retorna undefined.
  it('Verifica se caso o parâmetro passado não seja um número, a função `circle` retorna undefined', () => {
    expect(circle('caneta')).toBeUndefined();
  });

// Teste se o objeto retornado possui 3 propriedades.
  it('Verifica se a função `circle` retorna um objeto com três propriedades', () => {
    expect(circle.key).toEqual(circle.radius, circle.area, circle.circumference);
  });

// Teste se circle retorna um objeto contendo os valores esperados.
  it('Verifica se a função `circle` retorna os parâmetros corretos para círculo de raio 2', () => {
    expect(circle(2)).toEqual({radius:2, area:12.56,circumference: 12.56});
  });

  it('Verifica se a função `circle` retorna os parâmetros corretos para círculo de raio 3', () => {
...
//Teste se o parâmetro não for zero, a função retorna undefined.
  it('Verifica se ao receber um raio de zero, a função `circle` retorna undefined', () => {
